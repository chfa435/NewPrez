...
namespace NewTiceAI.Controllers
{
    public class AddressesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Address1,Address2,City,State,ZipCode")] Address address)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Address1,Address2,City,State,ZipCode")] Address address)
        {
            if (id != address.Id)
            {
                return NotFound();
