...
namespace NewTiceAI.Areas.Identity.Pages.Account
{
    public class RegisterByInviteModel : PageModel
    {
        ...
        public async Task OnGetAsync(int id, int companyId, string returnUrl = null)
        {
            ...
            Input.Company = invite.Organization.Name;
            Input.CompanyId = invite.OrganizationId;
        ...
        private TAUser CreateUser(int organizationId)
        {
            try
            {
                TAUser btUser = Activator.CreateInstance<TAUser>();
                btUser.FirstName = Input.FirstName; 
                btUser.LastName = Input.LastName;   
                btUser.OrganizationId = organizationId; 
